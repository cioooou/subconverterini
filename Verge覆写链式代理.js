...
function main(config) {
  ...
  config['geox-url'] = {
    geoip: 'https://mirror.ghproxy.com/https://raw.githubusercontentraw.githubusercontent.com/Loyalsoldier/geoip/release/geoip.dat',
    geosite: 'https://mirror.ghproxy.com/https://github.com/MetaCubeX/meta-rules-dat/releases/download/latest/geosite.dat',
    mmdb: 'https://mirror.ghproxy.com/https://raw.githubusercontentraw.githubusercontent.com/Loyalsoldier/geoip/release/Country.mmdb',
    asn: 'https://mirror.ghproxy.com/https://raw.githubusercontentraw.githubusercontent.com/Loyalsoldier/geoip/release/GeoLite2-ASN.mmdb'
  };
  ...
  config['proxy-groups'] = [
    // 主策略组
    {
      ...
      name: '🔰 节点选择',
      type: 'select',
      proxies: ['🔯 故障转移', '⚖️ 负载均衡', '🔗 链式代理', '🇭🇰 香港节点', '🇹🇼 台湾节点', '🇯🇵 日本节点', '🇸🇬 狮城节点', '🇺🇸 美国节点'],
      'include-all': true,
...
},
{
  ...
  "type": "relay",
  "proxies": ["✈️ 前置代理", "🛬 落地代理"],
  "icon": "https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Relay.png"
},
  ...
  config['rule-providers'] = {
    ...
    WeChat: {
      ...ruleProviderCommon,
      behavior: 'classical',
      url: 'https://raw.githubusercontent.com/Repcz/Tool/X/Surge/Rules/WeChat.list',
    ...
    Microsoft: {
      ...ruleProviderCommon,
      behavior: 'classical',
      url: 'https://raw.githubusercontent.com/cioooou/subconverterini/main/Microsoft.list',
    ...
    China: {
      ...ruleProviderCommon,
      behavior: 'classical',
      url: 'https://raw.githubusercontent.com/cioooou/subconverterini/main/China.list',
  ...
  // 覆盖规则
  config.rules = [
    'DOMAIN-KEYWORD,gfwlist,🔰 节点选择',
    'PROCESS-NAME,v2ray,🔰 节点选择',
    'PROCESS-NAME,xray,🔰 节点选择',
    'PROCESS-NAME,naive,🔰 节点选择',
    'PROCESS-NAME,trojan,🔰 节点选择',
    'RULE-SET,Block,🛑 广告拦截',
